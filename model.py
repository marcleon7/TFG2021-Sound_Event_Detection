...
def save_results(metrics=None):
    ...
    """
        ...
        Arguments ->
            metrics: Diccionari amb les puntuacions obtingudes del model
    """
...
def train_model(model=None, X=None, Y=None, X_test=None, Y_test=None, EPOCHS=None, BATCH_SIZE=None):
    ...
    """
        ...
        Arguments ->
            model: Model a entrenar
            X: Dades d'entrenament d'entrada
            Y: Dades d'entrenament de sortida reals
            X_test: Dades d'entrada de test
            Y_test: Dades de sortida de test
