...
def tagging_test_files(fold=None, audio_folder=None, setup_folder=None, fm=44100, nfft=2048, window_length=2048, hop_size=1024, n_mels=40, n_mfcc=12, frame_padding=None):
    ...
    """
        Descripció: Funció per generar les etiquetes de d'avaluació

        Arguments ->
            fold: Número de la carpeta
            audio_folder: Directori als arxius d'àudio
            setup_folder: Directori als arxius de test
            fm: Freqüència de mostreig
            nfft: Punts de la transformada
            window_length: Mida de la finestra
            hop_size: Mida del desplaçament
            n_mels: Nombre de bandes de Mel
            n_mfcc: Nombre de coeficients a generar
