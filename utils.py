...
def split_into_sequences(data=None, frame_padding=None):
    ...
    """
        Descripció: Concatena un segment amb els segments anteriors i posteriors segons el nombre de segments assigant per paràmetre

        Arguments ->
            data: Senyal a processar
            frame_padding: Nombre de segments anteriors i posteriors a concatenar

        Retorna ->
            Una matriu amb els segments processats
    """
